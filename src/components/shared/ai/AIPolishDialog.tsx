...
// markdown-exit instance: converts AI-returned Markdown to Tiptap-compatible HTML
const md = createMarkdownExit({
  html: true,       // allow HTML tags to pass through
  breaks: true,     // convert newlines to <br>
  linkify: false,   // resume content doesn't need auto-link detection
});

// turndown instance: converts Tiptap HTML to Markdown before sending to AI
    ...
    try {
      ...
      if (!rawText) {
        if (response.status === 401) {
          return "Authentication failed (401). Please check your API Key, model, and API Endpoint.";
        }
        return fallback;
      }
